...
public class BillDao {
    ...
    try{
        ResultSet rs = DbOperation.getData("Select *from bill where data like '&"+date+"&'");
        while(rs.next()){
        Bill bill = new Bill();
        bill.setId(rs.getInt("id"));
        bill.setName(rs.getString("name"));
        bill.setMobileNumber(rs.getString("email"));
        bill.setEmail(rs.getString("mobileNumber"));
    ...
    ArrayList<Bill> arraylist = new ArrayList<>();
    try{
        ResultSet rs = DbOperation.getData("Select *from bill where data like '&"+date+"&' order by id DESC");
        while(rs.next()){
        Bill bill = new Bill();
        bill.setId(rs.getInt("id"));
        bill.setName(rs.getString("name"));
